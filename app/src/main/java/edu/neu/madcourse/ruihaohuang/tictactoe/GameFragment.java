...
***/
package edu.neu.madcourse.ruihaohuang.tictactoe;
...
public class GameFragment extends Fragment {
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      mSoundX = mSoundPool.load(getActivity(), R.raw.tictactoe_sergenious_movex, 1);
      mSoundO = mSoundPool.load(getActivity(), R.raw.tictactoe_sergenious_moveo, 1);
      mSoundMiss = mSoundPool.load(getActivity(), R.raw.tictactoe_erkanozan_miss, 1);
      mSoundRewind = mSoundPool.load(getActivity(), R.raw.tictactoe_joanne_rewind, 1);
   }
